...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img src="{{asset('../../../public/assets/img/logo.png') }}" alt="logo"></a></div>
...
<!--Header_section-->
    ...
    <script type="text/javascript" src="{{asset('../../../public/assets/js/ckeditor5/ckeditor.js') }}"></script>
</body>
</html>
